...
import { Plus, Minus, Flower2, Sun, Moon, Wind, Heart, Sparkles, CheckCircle2, Home as HomeIcon, Edit2, Clock, Star, Zap, Calendar, ChevronDown, ShoppingCart, ArrowRight } from 'lucide-react';
...
export default function Yoga() {
  ...
  const [packageList, setPackageList] = useState<any[]>(DEFAULT_YOGA);
