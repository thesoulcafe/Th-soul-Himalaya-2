          ...
          >
            ...
            >
              ...
              <div className="px-8 md:px-16 pt-10 text-center md:text-left">
                ...
                >
                  <span className="font-fluid text-2xl md:text-3xl text-terracotta drop-shadow-sm mb-2 block">Divine Healing</span>
                ...
                <div className="flex items-center justify-center md:justify-start gap-4 text-forest/40 text-[10px] md:text-xs font-black uppercase tracking-widest">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-forest/80">{selectedPackage.rating || '4.9'} / 5.0 ({selectedPackage.reviews || '150'} reviews)</span>
                  </div>
                  <div className="w-1.5 h-1.5 rounded-full bg-terracotta/20" />
                  <span className="text-forest/80 font-bold">{selectedPackage.focus || 'Wellness'}</span>
                  <div className="w-1.5 h-1.5 rounded-full bg-terracotta/20" />
                  <span className="text-terracotta font-black">Healing</span>
                </div>
              </div>
