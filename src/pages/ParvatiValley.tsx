...
const PARVATI_DATA = {
  hero: {
    ...
    subheadline: "A Soulful Odyssey Through the Heart of the Kullu Himalayas",
  ...
  narrative: {
    ...
    content: "In the silken mists that rise from the Parvati River, one does not merely find a waterway, but the physical manifestation of Shakti herself. The river takes its name from the consort of Lord Shiva, who is said to have meditated for three millennia in these high glens. It is here that the concept of Shiva Shakti—the divine union of masculine and feminine principles—becomes visceral. To walk this valley is to walk between the ancient shadows of cedar forests and the blinding, transformative light of the Great Himalayan summits.",
  ...
  villages: [
    {
      name: "Malana",
      history: "Known as the oldest democracy in the world, the Malanese trace their lineage back to Alexander the Great's soldiers. Their culture is governed strictly by the ancient edicts of Jamlu Devta.",
      vibe: "#AncientDemocracy",
      icon: <Shield className="h-5 w-5" />,
      image: "https://images.unsplash.com/photo-1595928898133-9354334e47f4?q=80&w=1740&auto=format&fit=crop"
    },
    {
      name: "Tosh",
      history: "Clinging to the mountainside at 2,400m, Tosh is the ultimate gateway to the Pin Parvati Pass. It stands as a majestic sentinel bridging the lush forest and the stark alpine tundra.",
      vibe: "#HippieHideaway",
    ...
    {
      name: "Pulga",
      history: "Famed for its ethereal 'Fairy Forest', Pulga is a masterclass in traditional wooden housing. Its architecture whispers stories of centuries spent perfecting the art of timber framing in complete isolation.",
      vibe: "#TheWoodenHive",
      icon: <Mountain className="h-5 w-5" />,
      image: "https://images.unsplash.com/photo-1643527311836-1b882311dbdb?q=80&w=1740&auto=format&fit=crop"
    },
    {
      name: "Kheerganga",
      history: "The sacred site where Kartikeya, the son of Shiva, meditated. The milky-white waters of its natural hot springs remain a timeless haven for spiritual seekers seeking ritual purification.",
      vibe: "#SpiritualPeak",
...
const ParvatiValley = () => {
  ...
  return (
    <div className="min-h-screen bg-stone-50 selection:bg-terracotta/20 font-sans overflow-x-hidden pt-24">
      <Helmet>
        <title>Parvati Valley - High-Altitude Trekking & Yoga Retreats | Tosh, HP</title>
        <meta name="description" content="Explore Parvati Valley with our exclusive tour packages. Experience high-altitude trekking in Tosh, soul-stirring yoga retreats, and sustainable tourism in Himachal Pradesh." />
        <meta name="keywords" content="Tour Package Himachal Pardesh, trekking in Parvati valley, trekking in Tosh, yoga packages, meditation packages, corporate Tour packages, wfh in Parvati valley" />
          ...
          {`
            {
              ...
              "name": "Parvati Valley",
              "description": "A pristine Himalayan valley known for high-altitude trekking, ancient villages like Malana and Tosh, and spiritual yoga retreats.",
            ...
            <div className="relative z-10 w-full flex flex-col items-center justify-center p-8 md:p-12 bg-transparent text-white">
              <div className="max-w-3xl w-full space-y-6 text-center">
                ...
                >
                  ...
                  <h1 className="font-playfair text-4xl xs:text-5xl sm:text-6xl md:text-7xl lg:text-8xl text-white font-black italic tracking-tighter uppercase leading-none">
                    Shiva Shakti
                  </h1>
      ...
      <section className="py-24 px-6 text-center max-w-4xl mx-auto">
        <h2 className="text-3xl md:text-4xl font-heading font-bold text-forest mb-8">Ready for a soul-stirring adventure?</h2>
        <p className="text-lg text-forest/70 mb-10 max-w-2xl mx-auto">Whether you're seeking high-altitude trekking in Tosh, a tranquil yoga package, or a remote WFH retreat in Parvati Valley, your journey begins here.</p>
        <Button asChild className="bg-forest text-white h-16 px-12 rounded-2xl text-lg font-bold shadow-2xl shadow-forest/20 hover:scale-105 transition-transform uppercase tracking-widest">
          <Link to="/tours?category=Adventure">Book Your Expedition</Link>
        </Button>
      </section>
    </div>
  );
