                    ...
                    >
                      <div className="grid grid-cols-2 gap-4">
                        <div className="space-y-2 min-w-0">
                           ...
                           <input type="date" required className="w-full bg-[#faf9f6] border border-forest/10 rounded-2xl p-4 focus:ring-1 focus:ring-terracotta outline-none text-sm min-w-0" />
                        </div>
                        <div className="space-y-2 min-w-0">
                           <label className="text-[10px] font-black uppercase tracking-widest px-2">Time</label>
                           <input type="time" required className="w-full min-w-0 bg-[#faf9f6] border border-forest/10 rounded-2xl p-4 focus:ring-1 focus:ring-terracotta outline-none text-sm" />
                        </div>
                      </div>
