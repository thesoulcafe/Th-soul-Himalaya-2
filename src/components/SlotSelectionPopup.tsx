...
export default function SlotSelectionPopup({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="fixed bottom-0 sm:bottom-auto sm:top-1/2 left-1/2 -translate-x-1/2 sm:-translate-y-1/2 w-full sm:max-w-[540px] bg-[#FAF9F6] rounded-t-[2.5rem] sm:rounded-[3rem] border-none shadow-[0_-20px_100px_rgba(45,62,53,0.3)] p-0 overflow-y-auto max-h-[95vh] sm:max-h-[90vh] custom-scrollbar focus-visible:outline-none focus:outline-none block overscroll-behavior-contain transition-all duration-500">
        
        <div className="relative min-h-full pb-10 sm:pb-0">
          ...
          {/* Header Section */}
          <div className="bg-forest p-6 sm:p-12 text-white relative overflow-hidden">
            {/* Decorative Elements */}
          ...
          {/* Customize Section */}
          <div className="px-6 sm:px-10 py-6 border-t border-forest/5 bg-white/60 mb-8 sm:mb-0">
            <motion.div 
              whileHover={{ y: -3 }}
